//union means | in ts
//for example
let a: number | string; // yesma aba a ma ki number ki string duitai rakhna milxa bhana khojeko ho
...
let b: "sameer" | "suman"; // yesma aba b ma ki sameer ki suman rakhna milxa bhana khojeko ho
